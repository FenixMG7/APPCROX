        ...
        <header className="flex flex-col sm:flex-row justify-between items-center mb-8 gap-4">
          ...
          <div className="flex gap-4">
            <button
              ...
              className="flex items-center px-4 py-2 bg-amber-500 text-white font-semibold rounded-lg shadow hover:bg-amber-600 transition-colors disabled:bg-amber-300 disabled:cursor-not-allowed"
            >
              <ResetIcon />
              Archiver la semaine
            </button>
